...
def train_model():
    ...
    net.SGD(test_tuples[:10000], 100, 50, 0.5, test_data=test_tuples[10000:])
...
def evaluate(net):
    ...
    evaluate_list(net, ["pogera","tupils","fement","gorbed","sering","margim","borsan","forgin","profil","blenin","profes","mutane","globas","harish","mangal","sharma"], lambda prob: True)
